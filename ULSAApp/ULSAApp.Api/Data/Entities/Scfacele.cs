...
namespace ULSAApp.Api.Data.Entities
{
    public partial class Scfacele
    {
        ...
        public bool? FefacEnv { get; set; }
        public short? FetipPac { get; set; }
        public DateTime? FefecCan { get; set; }
        public string Feobserv { get; set; }
        public string Feusuario { get; set; }
        public string Feuuidref { get; set; }
    }
}
